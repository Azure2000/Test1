...
function Publish-AdfV2FromJson {
    ...
    Write-Host "===================================================================================";
    Write-Host "STEP: Reading last state of deployment..."
    $adfi = Get-AzDataFactoryV2 -ResourceGroupName "$ResourceGroupName" -DataFactoryName "$DataFactoryName"
    $adfi.GlobalParameters
    $lastState = ('{ "md5": [ {"pipe":"45ef43"} ] }' | ConvertFrom-Json)
    $lastState.md5
    ...
    $adf.$lastState = $adfi.GlobalParameters['__adftools_state']
    ...
    Write-Host "===================================================================================";
    Write-Host "STEP: Updating deployment state..."
    $adf.
